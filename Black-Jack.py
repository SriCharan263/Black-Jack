...
class Hand:
    ...
    def add_card(self,card_list):
        self.cards_at_hand.extend(card_list)

    def calculate_value(self):
        has_ace = False
        self.value = 0

        for card in self.cards_at_hand:
    ...
    def display(self, show_all_dealer_cards = False):
        ...
        for index,card in enumerate(self.cards_at_hand):
...
class Game:
    ...
    def play(self):
        ...
        while games_to_play <= 0:
            try:
                games_to_play = int(input('How many games do you want ton play? '))
            except:
    ...
    def check_winner(self,player_hand,dealer_hand, game_over=False):
        ...
        if not game_over:
            if player_hand.get_value() > 21 :
                ...
                print("Both the player and dealer have blackjack! It's a tie!!")
                return True
